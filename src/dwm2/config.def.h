...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_t,      spawn,          SHCMD("blueman-manager") },
    { MODKEY|ShiftMask,             XK_b,      spawn,          SHCMD("nm-connection-editor") },
    { MODKEY|ShiftMask,             XK_k,      spawn,          SHCMD("kitty") },
